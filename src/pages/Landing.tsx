...
import { Search,  Star, Clock, MapPin,  Menu, X,  Phone, Mail, Facebook, Twitter, Instagram, ChefHat, Truck, Shield, Zap, ArrowRight, PlayCircle } from 'lucide-react';
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    <div className="col-span-1 md:col-span-2">
                        ...
                        <div className="flex space-x-4">
                            ...
                            <Twitter className="w-6 h-6 text-gray-400 hover:text-orange-600 cursor-pointer transition-colors" />
